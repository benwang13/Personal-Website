  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Benjamin Wang - Data Science and Sustainable Development at Columbia University"
        />

        {/* Open Graph / Social Media Meta Tags */}
        <meta property="og:title" content="Ben Wang" />
        ...
        >
          <div className="space-y-8">
            ...
            <div className="text-xl text-[#1e3a8a] space-y-4 text-left">
              ...
              <p>
                I have a strong passion for using data science and geospatial science to fight the climate crisis
              </p>
              <p>You can reach me at bw2730[at]columbia[dot]edu</p>
            </div>
          </div>
        </div>
        ...
        <section className="max-w-4xl mx-auto pt-0 pb-20 px-6 relative z-20">
          ...
          <div className="space-y-8">
            {education.map((edu, index) => (
              <div
                key={index}
                className="flex flex-col md:flex-row items-center md:items-start gap-6 p-6 font-crimson"
              >
                {edu.image && (
                  <Link
                    href={edu.link}
                    className="w-20 md:w-32 h-20 md:h-32 relative flex-shrink-0 drop-shadow-[0_4px_4px_rgba(85,107,47,0.25)] hover:opacity-80 transition-opacity"
                  >
                    <Image
                      src={edu.image}
                      alt={edu.school}
